...
int main() {	
	...
	if (pustB > 0) {
		if (pustB == 4) {
			if (kverhA == 4) {kolba[0][B] = verhA; kolba[1][B] = verhA; kolba[2][B] = verhA; kolba[3][B] = verhA;}
			if (kverhA == 3) {kolba[0][B] = verhA; kolba[1][B] = verhA; kolba[2][B] = verhA;}
			if (kverhA == 2) {kolba[0][B] = verhA; kolba[1][B] = verhA;}
			if (kverhA == 1) {kolba[0][B] = verhA;}
		...
		if (pustB == 3) {
			if (kverhA == 3) {kolba[1][B] = verhA; kolba[2][B] = verhA; kolba[3][B] = verhA;}
			if (kverhA == 2) {kolba[1][B] = verhA; kolba[2][B] = verhA;}
		...
		if (pustB == 2) {
			if (kverhA == 2) {kolba[2][B] = verhA; kolba[3][B] = verhA;}
