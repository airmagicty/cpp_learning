...
m:	
	...
	while (x > 1 && x < 78 && y < 24 && y > 0)
    {
    	...
    	switch (vbr)
    	{
    		...
    		case 172: cout << char1; Cursor(x,y); x2=x; y2=y; kvadrat(x, y, x1, y1, x2, y2, char1); break;	// v
    		case 99: cout << char1; Cursor(x,y); x1=x; y1=y; break;	// с
    		case 118: cout << char1; Cursor(x,y); x2=x; y2=y; kvadrat(x, y, x1, y1, x2, y2, char1); break;	// м
    		// Color simvolov
