...
//	}
	...
	int dbBG_section_int = 4, dbBG_section_char = 2, dbBG_day = 365;
...
//			year_student_all[month_i][day_i] = GroupInput[y_count];
			...
			databaseBaseGenerate_int[0][y_count] = year;
			databaseBaseGenerate_int[1][y_count] = month_i+1;
			databaseBaseGenerate_int[2][y_count] = day_i+1;
...
//			if (y_count_clone > count_GroupInput_null) y_count_clone = 0 + bias;
//			y_count_clone++;
			
			
//			if (y_count_clone == count_GroupInput_null) {
//				if (y_count == 0) {
//					bias = 0;
//				} 
//				bias = y_count+1 % count_GroupInput;
//			}
