...
void BOOM2_end()
{
	cout << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl
		 << "  ===========================================" << endl <<
			...
			"  ||X=X         X=X=X=X=X=X=X  MM       MM ||" << endl <<
			"  ===========================================" << endl <<
			"Vi viigrali!" << endl << "Comp proigral " << endl;
}
// Func Boom2
...
int main ()
{
	...
	<< "Sdes ti igraes s compom po ocheredi :)" << endl
	<< "V konze napisut kto viigral..." << endl
	<< "Udachi!" << endl;
	system ("pause");
	...
	// Pole
	int s=0, r, ra, rb, rc, rd, re, rf, rg, rh, xp = 0, v=1, x, k=0;
	...
	if (k % 2 == 0)
	{
		 cout << "No!... No!... No!... Moi hod! Loading... " << endl;
		 system ("pause");
...
//			goto R;
		 ...
		 // M2
		if (r == Ra || r == Rb || r == Rc || r == Rd || r == Re)	{BOOM2_end(); goto n;}
		if (r == Rf || r == Rg || r == Rh || r == Ri || r == Rj)	{BOOM2_end(); goto n;}
		if (r == Rk || r == Rl || r == Rm || r == Rn || r == Ro)	{BOOM2_end(); goto n;}
		if (r == Rp || r == Rq || r == Rr || r == Rs || r == Rt)	{BOOM2_end(); goto n;}
		if (r == Ru || r == Rv || r == Rw || r == Rx || r == Ry || r == Rz)	{BOOM_end(); goto n;}
		// M2
	}
	// pk
